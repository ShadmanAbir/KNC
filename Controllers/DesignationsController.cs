...
namespace KNC.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DesignationID,DesignationName,Description,IsDeleted,CreatedBy,CreatedDate")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DesignationID,DesignationName,Description,IsDeleted,CreatedBy,CreatedDate")] Designation designation)
        {
